...
class Test_AMZN_Search(Test_AMZN_Search_Base):
    ...
    def test_user_should_be_able_to_add_item_to_cart(self):
        ...
        self.productDetailsPage.click_add_item_to_cart()
...
if __name__ == '__main__':
    ...
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="/Users/pengkedi/Documents/selenium/projects/selenium_amazon/Reports"))
